...
import  medakdata from'./topojsons/Telangana/medakdata.json';
const TelanganaAssembly = ({ selectedDistrict}) => {
  
  let districtData;
  if (selectedDistrict === 'Hyderabad') {
    districtData = medakdata;
  } 
...
export default TelanganaAssembly;